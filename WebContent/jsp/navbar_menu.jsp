...
<%@ taglib prefix="shiro" uri="http://shiro.apache.org/tags" %>
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> ${bean.account.nickname}<span class="caret"></span></a>
							<ul class="dropdown-menu" role="menu">
								<li><a href="/shadowsatyr/index"><span class="glyphicon glyphicon-home"></span> Home</a></li>
								<!--<li><a href="/shadowsatyr/user/createarticle"><span class="glyphicon glyphicon-pencil"></span> Create article</a></li>  -->
